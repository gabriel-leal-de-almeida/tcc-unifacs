...
resource "google_storage_bucket_object" "process_data_dataproc_script" {
  ...
  output_name = "${var.dataproc_scripts_folder}process_data.py"
...
resource "google_storage_bucket_object" "read_data_dataproc_script" {
  name   = "read_data.py"
  output_name = "${var.dataproc_scripts_folder}read_data.py"
  bucket = var.bucket_name
...
resource "google_storage_bucket_object" "collect_metrics_functions_script" {
  ...
  output_name = "${var.functions_scripts_folder}collect_metrics.py"
  bucket = var.bucket_name
...
resource "google_storage_bucket_object" "start_process_data_functions_script" {
  name   = "start_process_data.py"
  output_name = "${var.functions_scripts_folder}start_process_data.py"
  bucket = var.bucket_name
...
resource "google_storage_bucket_object" "start_read_data_functions_script" {
  name   = "start_read_data.py"
  output_name = "${var.functions_scripts_folder}start_read_data.py"
  bucket = var.bucket_name
...
resource "google_storage_bucket_object" "start_collect_metrics_functions_script" {
  name   = "start_collect_metrics.py"
  output_name = "${var.functions_scripts_folder}start_collect_metrics.py"
  bucket = var.bucket_name
